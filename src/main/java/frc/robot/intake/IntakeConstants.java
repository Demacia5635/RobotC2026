...
public class IntakeConstants {
    ...
    public static final double DEPLOY_CLOSED_ANGLE = Math.toRadians(-30.0);
    public static final double DEPLOY_OPEN_ANGLE = Math.toRadians(90.0);
    public static final double ANGLE_IS_COAST = Math.toRadians(10.0);
    ...
    // public static final double KG_SLOT0 = kg;
    // public static final double KG_SLOT1 = -kg; 
    ...
    public static final TalonFXConfig INTAKE_DEPLOY_CONFIG = new TalonFXConfig(INTAKE_DEPLOY_ID, INTAKE_CANBUS,
        ...
        // .withPID(0, kp, ki, kd, ks, kv, ka, KG_SLOT0)
        // .withPID(1, kp, ki, kd, ks, kv, ka, KG_SLOT1)
