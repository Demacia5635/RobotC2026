...
public class Shooter extends SubsystemBase {
  ...
  public boolean isReady(){
    return (Math.abs(wantedVel - flywheel.getCurrentVelocity()) < (shooter.getShooterState().equals(ShooterStates.DELIVERY) ?2: FlywheelConstants.FLYWHEEL_VELOCITY_OFFSET) &&
